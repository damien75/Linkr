...
public class ProfileActivity extends Activity {
    ...
    class BitmapWorkerTask extends AsyncTask<Integer, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Integer... params) {
            ...
            URL url = null;
            try {
                url = new URL("www.golinkr.net/images/carlos_gohsn.jpg");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options.inJustDecodeBounds = true;
        BitmapFactory.decodeResource(getResources(), R.id.profile_picture, options);
        int imageHeight = options.outHeight;
        int imageWidth = options.outWidth;
        String imageType = options.outMimeType;
        ImageView mImageView = (ImageView) findViewById(R.id.profile_picture);
        mImageView.setImageBitmap(
                decodeSampledBitmapFromResource(getResources(), R.id.profile_picture, 100, 100));
